...
\title{Tram's Homework Template}%replace X with the appropriate number
\author{Tram To\\ %replace with your name
MATH 2834 Calculus I} %if necessary, replace with your course title
 
\maketitle

\section{Introduction}
Here we talk about how great \textit{MY} \textbf{WORK} is.

\section{Methods}
Other ways people have done this.

\subsection{Advice from Advisor...}
Other good things.
